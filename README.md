...
<head>
  ...
  <title>Update In Few Days</title>
  <style>
    :root{
      --bg1:#0f1226;
      --bg2:#111827;
    ...
    *{box-sizing:border-box}
    ...
    body{
      ...
      color:var(--fg);
      background: radial-gradient(1200px 800px at 20% 10%, #0b1022, transparent 60%),
                  radial-gradient(900px 600px at 80% 90%, #121a33, transparent 60%),
    ...
    h1{
      ...
      text-shadow: 0 0 18px rgba(147,197,253,.25);
    }
    .sub{
      margin:0 auto 18px;
      max-width:55ch;
